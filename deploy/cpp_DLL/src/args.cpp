...
DEFINE_bool(benchmark_, false, "Whether use benchmark_.");
DEFINE_string(output, "./output", "Save benchmark_ log path.");
...
// detection related
DEFINE_string(det_model_dir, "./resources/ch_PP-OCRv4_det_infer", "Path of det inference model.");
...
DEFINE_double(det_db_box_thresh, 0.7, "Threshold of det_db_box_thresh.");
...
DEFINE_string(cls_model_dir, "./resources/ch_ppocr_mobile_v2.0_cls_infer", "Path of cls inference model.");
DEFINE_double(cls_thresh, 0.9, "Threshold of cls_thresh.");
DEFINE_int32(cls_batch_num, 1, "cls_batch_num.");

// recognition related
DEFINE_string(rec_model_dir, "./resources/japan_PP-OCRv4_rec_infer", "Path of rec inference model.");
DEFINE_int32(rec_batch_num, 6, "rec_batch_num.");
DEFINE_string(rec_char_dict_path, "./resources/japan_dict.txt", "Path of dictionary.");
...
//custom flags
DEFINE_string(extracted_file, "", "Path of extracted text file.");
DEFINE_string(logfile, "", "Path of log file.");
