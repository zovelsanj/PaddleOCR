...
// detection related
DEFINE_string(det_model_dir, "./resources/chinese/ch_PP-OCRv4_det_infer", "Path of det inference model.");
...
DEFINE_string(cls_model_dir, "./resources/multilanguage/ch_ppocr_mobile_v2.0_cls_infer", "Path of cls inference model.");
...
DEFINE_string(rec_char_dict_path, "./resources/japan_dict.txt",
              "Path of dictionary.");
