...
// detection related
DEFINE_string(det_model_dir, "../../models/chinese/ch_PP-OCRv4_det_infer", "Path of det inference model.");
...
DEFINE_string(cls_model_dir, "../../models/multilanguage/ch_ppocr_mobile_v2.0_cls_infer", "Path of cls inference model.");
DEFINE_double(cls_thresh, 0.9, "Threshold of cls_thresh.");
DEFINE_int32(cls_batch_num, 1, "cls_batch_num.");
// recognition related
DEFINE_string(rec_model_dir, "../../models/multilanguage/japan_PP-OCRv4_rec_infer", "Path of rec inference model.");
